...
class _MaterialUploadScreenState extends State<MaterialUploadScreen> {
  ...
  Future<void> _uploadAndGenerateRoadmap() async {
    ...
    try {
      final fields = <String, String>{'user_id': user.id.toString()};
      if (_appendToExistingSession && _selectedSessionId != null) {
      ...
      final message = appended
          ...
          : '🎉 자료 $uploadedCount개 분석 완료! 맞춤형 학습 코스가 생성되었습니다.';
        ...
        child: Column(
          ...
          children: [
            ...
            if (_isUploading)
              ...
              DuoButton(
                text: _appendToExistingSession ? '기존 로드맵에 자료 추가' : '자료 분석 및 퀴즈 코스 생성',
                color: const Color(0xFF58CC02),
                shadowColor: const Color(0xFF46A302),
                onPressed: canUpload ? _uploadAndGenerateRoadmap : null,
              ),
            ],
          ],
        ),
